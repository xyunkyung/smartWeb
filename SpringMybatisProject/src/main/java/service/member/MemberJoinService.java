...
public class MemberJoinService {
	...
	public void memJoin(MemberCommand memberCommand) {
		...
		String subject = "가입 환영 인사";
		String content = "<html><body>"
						+ " 안녕하세요. " + dto.getMemId() + "님 가입을 축하드립니다."
						+ " 아래 링크를 눌러야 가입이 완료 됩니다. <br />"
						+ " <a href='http://192.168.0.9:8080/SpringMybatisProject/register/memberMail?"
						+ "num=" + num
						+ "&receiver=" + dto.getMemEmail() + "'>가입을 완료하시려면 클릭하세요.</a>"
						+ "</body></html>";
