...
public class PaymentDTO {
	...
	public String getPaymentApptrDate() {
		return paymentApptrDate;
	}
	public void setPaymentApptrDate(String paymentApptrDate) {
		this.paymentApptrDate = paymentApptrDate;
	}
