...
<body>
<form action="goodsJoin.gd" name="frm" method="post" enctype="multipart/form-data"> <!-- 파일 날리기 -->
	<table border=1 align="center">
		...
		<tr><th>추천 상품</th>
			<td><input type="radio" name="recommend" value="Y" />추천
				<input type="radio" name="recommend" value="N" />비추천</td></tr>
		<tr><th>상품 설명</th>
		...
		<tr><th>파일</th>
			<td><input type="file" name="prodImage1" /><br />
				...
				<input type="file" name="prodImage3" /></td></tr>
		<tr><th colspan="2">
